...
void smartlist_uniq(smartlist_t *sl,
                    int (*compare)(const void **a, const void **b),
#ifdef DEBUG_MALLOC
                    void (*free_fn)(void *elt,const char *,int));
#else
...
#ifdef DEBUG_MALLOC
#define FREE_VAL void (*free_val)(void*,const char *,int)
#else
#define FREE_VAL void (*free_val)(void*)
#endif
...
#define DECLARE_MAP_FNS(maptype, keytype, prefix)                       \
  ...
  void prefix##free(maptype *map,FREE_VAL);             \
...
#define DECLARE_TYPED_DIGESTMAP_FNS(prefix, maptype, valtype)           \
  ...
  static INLINE void prefix##free(maptype *map,FREE_VAL)		\
  {                                                                     \
